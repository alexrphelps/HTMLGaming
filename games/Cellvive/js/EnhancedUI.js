...
class EnhancedUI {
    ...
    renderHUD() {
        ...
        const sprintPercent = player.sprintEnergy / player.maxSprintEnergy;
        ctx.fillStyle = sprintPercent > 0.5 ? '#ffaa00' : sprintPercent > 0.25 ? '#ff6600' : '#ff0000';
        ctx.fillRect(20, 45, 200 * sprintPercent, 12);
        ...
        ctx.fillStyle = '#ffffff';
        ctx.font = '10px Arial';
        ctx.fillText(`Sprint: ${Math.round(player.sprintEnergy)}/${player.maxSprintEnergy}`, 25, 55);
