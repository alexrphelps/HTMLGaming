(function (ns) {
    class Input {
        constructor(target) {
            ...
            this.onDown = this.onDown.bind(this); this.onUp = this.onUp.bind(this); this.onBlur = this.onBlur.bind(this); this.onMouseDown = this.onMouseDown.bind(this); this.onMouseUp = this.onMouseUp.bind(this); this.onMouseMove = this.onMouseMove.bind(this);
